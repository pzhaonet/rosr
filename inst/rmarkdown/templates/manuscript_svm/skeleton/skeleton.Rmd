---
title: Template for your manuscript using RMarkdown
...
output: 
  bookdown::pdf_book:
    base_format: rosr::manuscript_svm # for using bookdown features like \@ref()
...
# header-includes:  # enable this line for using `~~text~~` to break through texts.
#    - \usepackage{ulem}
---
